...
# Bind the persistence helpers that still live here onto the stats module so its
# moved compute functions resolve them in their own namespace (until Step 5).
_stats_io._load_nav_log = _load_nav_log
_stats_io._load_trade_log = _load_trade_log
_stats_io._load_manual_paper_cash = _load_manual_paper_cash
_stats_io._account_initial_capital_from_files = _account_initial_capital_from_files
